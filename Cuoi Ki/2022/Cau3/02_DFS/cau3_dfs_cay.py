...
def solve():
    ...
    path, goal, total_cost, exploration_order, steps = dfs_to_zero_heuristic_goal(graph, "S")
    lines = ["THUAT TOAN DFS", "Thu tu dinh kham pha:", " -> ".join(exploration_order), "", format_steps(steps), ""]
    if path is None:
