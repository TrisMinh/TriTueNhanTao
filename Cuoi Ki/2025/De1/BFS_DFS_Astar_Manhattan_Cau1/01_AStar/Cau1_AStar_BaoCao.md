...
- `h(x)`: khoảng cách Manhattan từ ô hiện tại đến rìa gần nhất.
...
ta cần ước lượng khoảng cách từ ô đó đến rìa lâu đài. Vì rìa lâu đài gồm 4 cạnh của ma trận nên khoảng cách Manhattan ngắn nhất đến rìa là khoảng cách nhỏ nhất đến 4 cạnh:
...
Trong code, em viết theo dạng Manhattan:
...
Về mặt hình học, rìa gần nhất của một ô trong ma trận luôn nằm theo một trong 4 hướng thẳng: lên trên, sang trái, xuống dưới hoặc sang phải. Vì vậy khoảng cách Manhattan đến rìa gần nhất chính là giá trị nhỏ nhất trong 4 khoảng cách trên.
...
| `heuristic_to_border` | Tính `h(x)`, tức khoảng cách Manhattan từ ô hiện tại đến rìa gần nhất |
...
- `h`: khoảng cách Manhattan ước lượng đến rìa gần nhất.
